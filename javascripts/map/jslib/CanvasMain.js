  ...
  options: {
    ...
    */
    initMap: function(id) {
        ...
        this.baseUrl = '/javascripts/map';
	    //get请求获取服务第一页的结果
        Atlas.Ajax.get(this.baseUrl+"/jsondata/0.json",function(xhr,data){
             var jsonObj;
    ...
    */
    ...
    _resetRequest: function(){
	    ...
	    //get请求获取服务下一页的结果
        Atlas.Ajax.get(that.baseUrl+"/jsondata/"+that.page+".json",function(xhr,data){
        	var jsonObj;
             if(data){
            	 jsonObj = Atlas.Util.evalJSON(data);
